...
const ForgotPassword = () => {
    ...
    const eventHandler = (e:any) =>{
        ...
        axios.post("/user/forgotpassword", { email:checkEmail })
  ...
  return (
    <div>
        <form action="" style={{textAlign:"center"}}>
            ...
            <input type="email" name="email" placeholder='email' onChange={(e:any)=>{setCheckEmail(e.target.value)}} />
            <br />
            <button onClick={eventHandler}> Submit </button>
            <br />
            
            {showBtn?<Link to={url}><button>Click</button></Link>:""}
